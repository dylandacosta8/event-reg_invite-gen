...
class InviteService:
    ...
    @classmethod
    async def create_invitation(cls, session: AsyncSession, user_id: UUID, invitee_email: str, nickname: str, email_service: EmailService) -> Optional[Invitation]:
        """
        Create an invitation linked to a user with a unique invite code.
